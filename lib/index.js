...
__export(src_exports, {
  ...
  ApplicationFilesManager: () => ApplicationFilesManager,
  ApplicationManager: () => ApplicationManager,
  ApplicationNetworkManager: () => ApplicationNetworkManager,
  ApplicationStatus: () => ApplicationStatus,
  BaseApplication: () => BaseApplication2,
  CacheManager: () => CacheManager,
  Collection: () => Collection2,
  SimpleApplicationStatus: () => SimpleApplicationStatus,
  SquareCloudAPI: () => SquareCloudAPI5,
...
// src/index.ts
var SquareCloudAPI5 = class extends TypedEventEmitter {
  /**
  ...
  constructor(apiKey) {
    ...
    __publicField(this, "applications", new ApplicationManager(this));
    /** The users manager */
    __publicField(this, "users", new UserManager(this));
    /** The global cache manager */
    __publicField(this, "cache", new CacheManager());
    assertString(apiKey, "API_KEY");
    this.api = new APIManager(apiKey);
  }
};
__publicField(SquareCloudAPI5, "apiInfo", {
  latestVersion: "v2",
